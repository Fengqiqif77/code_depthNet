...
def main():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="/home/hp/anaconda3/envs/FYQtest/project/DepthNet/checkpoint5/", help="The path to the checkpoint directory")
    parser.add_argument("--continue_train", type=bool, default=False, help="Continue train")
    parser.add_argument("--restore_path", type=str, default="/home/hp/anaconda3/envs/FYQtest/project/DepthNet/checkpoint5/", help="The path to load checkpoint")
